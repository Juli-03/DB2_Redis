...
%	
\begin{acronym}[YTMMM]
\setlength{\itemsep}{1.1em} % Vertikaler Abstand zwischen den Acronyms
...
\acro{Pub/Sub}{Publisher Subscriber}
\acro{RAM}{Random Access Memory}
\acro{RDB}{Redis Database}
\acro{AOF}{Append Only File}
\acro{ACL}{Access Control List}
\acrodefplural{ACLs}{Access Control Lists}
\acro{TLS}{\gls{Transport Layer Security}}
